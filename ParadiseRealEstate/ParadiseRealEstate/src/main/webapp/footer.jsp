	<footer class="full-row bg-secondary p-0">
    	<div class="container">
                    	...
                    	<div class="row">
                        	<div class="col-md-12 col-lg-4">
                            	<div class="footer-widget mb-4">
                                    ...
                                    <p class="pb-20 text-white"><b>Paradise Real Estate</b> is a full stack service provider for all real estate needs, with 15+ services including home loans, pay rent, legal assistance, property valuation, and expert advice. As the largest platform for buyers and sellers of property to connect in a transparent manner, <b>Paradise Real Estate</b> has an active base of over 15 lakh property listings.</p>
								</div>
                           	</div>
                                    ...
                                    <div class="col-md-4 col-lg-4">
                                    	<div class="footer-widget footer-nav mb-4">
                                            ...
                                            <ul class="hover-text-primary">
                                                ...
                                                <li><a href="feature.jsp" class="text-white">Featured Property</a></li>
                                                <li><a href="submitproperty.jsp" class="text-white">Submit Property</a></li>
                                                <li><a href="agent.jsp" class="text-white">Our Agents</a></li>
                                                <li><a href="admin-index.jsp" class="text-white">Admin</a></li>
                                          	</ul>
                                      	</div>
                                    </div>
                                	<div class="col-md-4 col-lg-4">
                                    	<div class="footer-widget">
                                            ...
                                            <ul class="text-white">
                                            	<li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>1 to 5, Mohan Nagar, Chinchwad - 411001</li>
                                                <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+91 96071 77899</li>
												<li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+91 20 26166499</li>
                                                <li class="hover-text-primary"><i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>sales@paradiserealestatest.com</li>
                                        	</ul>
										</div>
            ...
            <div class="row copyright">
            	<div class="col-sm-6"> <span class="text-white">&copy; <%=new java.util.Date().getYear()+1900%> Real Estate Website - Developed By Avinash Bhalerao</span> </div>
                <div class="col-sm-6">
