            		...
            		<div class="container">
                		<div class="row">
							<div class="col-lg-8">
                        		<div class="row">
<%
	ResultSet query = con.createStatement().executeQuery("SELECT property.*, user.uname,user.utype FROM property,user WHERE property.uid=user.uid");
	while(query.next()){
%>						
									<div class="col-md-6">
                                		<div class="featured-thumb hover-zoomer mb-4">
                                    		...
                                    		<div class="featured-thumb-data shadow-one">
                                        		<div class="p-4">
                                            		<h5 class="text-secondary hover-text-success mb-2 text-capitalize"><a href="propertydetail.jsp?pid=<%=query.getInt(1)%>"><%=query.getString(2)%></a></h5>
