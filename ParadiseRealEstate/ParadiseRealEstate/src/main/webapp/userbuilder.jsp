						...
						<div class="col-sm-12">
							<div class="card">
								...
								<div class="card-body">
									...
									<tbody>
<%
	ResultSet query = con.createStatement().executeQuery("select * from user where utype='builder'");
	int cnt = 1;
	while(query.next()){
%>									
									<tr>
										...
										<td><img src="assets/img/profiles/<%=query.getInt(1)%>.jpg" height="50px" width="50px"></td>
    									<td><a href="userbuilderdelete.jsp?id=<%=query.getInt(1)%>" onclick="return confirm('Are you sure?')"><button class="btn btn-danger">Delete</button></a></td>
                                  	</tr>
<%
	}
%>                                  	
